...
describe("DELETE to api/v1/user", () => {
  describe("Default user", () => {
    test("Witch valid session", async () => {
      ...
      const doubleCheckReponse = await fetch(
      ...
      expect(doubleCheckReponse.status).toBe(401);

      const doubleCheckReponseBody = await doubleCheckReponse.json();
      expect(doubleCheckReponseBody).toEqual({
